...
heuristics = {1 : DOMAIN, 2 : DOM_DDEG, 3 : DOM_WDEG, 4 : ACTIVITY, 5 : IMPACT}
...
def COMMON_CHOICE(Free, Vars, depth, r = 1, k = 1, counter_heuristic = {}, counter_times = {}, counter_choice = {}) :
    ...
    for heuristic in range(2,6) :
        HEURISTICS_VARS.append(heuristics[heuristic](Free, Vars, depth, r, k, ALL = 1))
